    ...
    <div className="rounded-2xl border border-[#e8e6e1] bg-white p-5">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-base font-semibold text-[#1a1a1a] flex items-center gap-2">
          {title}
          {enCours.length > 0 && (
            <span className="flex h-5 min-w-5 items-center justify-center rounded-full bg-[#c8956c]/15 text-[11px] font-bold text-[#c8956c] px-1.5">
              {enCours.length}
            </span>
          )}
        </h3>
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-8 text-center">
          ...
          <button onClick={openNew} className="mt-2 text-xs font-semibold text-[#c8956c] hover:underline">
